        ...
        >
          <ul className="flex flex-col">
            <li className="flex gap-2 items-center">
              {" "}
              <FaArrowTurnUp className="rotate-90" /> Enable your device's
              location.
            </li>
            <li className="flex gap-2 items-center">
              {" "}
              <FaArrowTurnUp className="rotate-90" /> Enter the code emailed to
              you.
            </li>
          </ul>
        </div>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              onClick={() =>
                window.open(
                  "https://automation-showcase-devday25.vercel.app",
                  "_blank"
                )
              }
